...
// IMPORTAÇÃO CORRIGIDA: O caminho está correto, mas a declaração de tipos está em 'types.ts'
// Garantindo que a importação é única e correta.
import { type Planejamento, type LessonPlanCardProps, mockPlanejamento } from './types';
